<template>
  <div class="flex flex-col space-y-8">
    <div class="flex flex-wrap ">
      <div class="w-1/2 p-4">
        <div class="flex w-full max-w-xs p-4 bg-white shadow-10">
          <ul class="flex flex-col w-full">
            <li class="my-px">
              <a
                href="#"
                class="flex flex-row items-center h-12 px-4 text-gray-600 bg-gray-100 rounded-lg"
              >
                <span
            ...
            <li class="my-px">
              <span
                class="flex px-4 my-4 text-sm font-medium text-gray-400 uppercase"
                >Projects</span
              >
            </li>
            <li class="my-px">
